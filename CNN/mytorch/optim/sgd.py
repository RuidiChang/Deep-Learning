    ...
    def step(self):
        ...
        for i in range(self.L):
            ...
            if self.mu == 0:
                ...
                self.v_W[i] = self.mu*self.v_W+self.l[i].dLdW # TODO
                self.v_b[i] = self.mu*self.v_b+self.l[i].dLdb # TODO
                self.l[i].W = self.l[i].W-self.lr*self.v_W # TODO
                self.l[i].b = self.l[i].b-self.lr*self.v_b # TODO
